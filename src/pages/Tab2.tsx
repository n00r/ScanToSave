  ...
  return (
    <IonPage>
      ...
      <IonContent >
        ...
        <CustomerComponent CustomerModal={showCustomerModal} onhandlecustomer={handlecustomer} />
        <CheckoutComponent CheckoutModal={showCheckoutModal} onhandlecheckout={handlecheckout} />
